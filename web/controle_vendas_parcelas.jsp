...
<html>
    <head>
        <title>Controle de Venda Veículos</title>
    ...
    <body>
        ...
        <logic:notEqual name="nome" value="" scope="session">
            ...
            <div align="center">
                <h1>Lista de Parcelas de Veículos Vendidos</h1>
                <hr/>
            </div>
                ...
                <div style="border: 0px solid black; padding: 20px; background-color: #FAFAD2;">
                    <table width="60%" border="0" align="center" class="table-condensed">
                        ...
                        <tr>
                            ...
                            <td width="25%">
                                <b>Marca Veículo:</b> <bean:write name="ControleVendasModel" property="dsMarcaVeiculo"/>
                            </td>
                            <td width="25%">
                        ...
                        <tr>
                            <td width="25%">
                                <b>Ano Veículo:</b> <bean:write name="ControleVendasModel" property="ano"/>
                            </td>
                            <td width="25%">
                        ...
                        <tr>
                            <td width="25%">
                                <b>Preço Venda:</b> ¥<bean:write name="ControleVendasModel" property="precoVenda"/>
                            </td>
                            <td width="25%">
                        ...
                        <tr>
                            <td colspan="3">
                                <b>Observação:</b> <bean:write name="ControleVendasModel" property="detalhesExtras"/>
                            </td>
                        </tr>
