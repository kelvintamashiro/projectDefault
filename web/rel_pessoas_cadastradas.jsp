        ...
        <html:form action="Relatorio">
            <table width="90%" class="table-condensed" align="center" id="exportable_table">
                <tr style="background-color: #D3D3D3">
                    <td><b>ID</b></td>
                    <td><b><a href="javascript:fFiltrar('nome')" style="color: black">Nome <img src="imagens/up-arrow.png" width="12px"/> </a></b></td>
                    <td><b><a href="javascript:fFiltrar('data_nascimento')" style="color: black">Data Nascimento <img src="imagens/up-arrow.png" width="12px"/></a></b></td>
                    <td><b><a href="javascript:fFiltrar('sexo')" style="color: black">Sexo <img src="imagens/up-arrow.png" width="12px"/></a></b></td>
                    ...
                    <td><b><a href="javascript:fFiltrar('telefone')" style="color: black">Telefone <img src="imagens/up-arrow.png" width="12px"/></a></b></td>
                    <td><b><a href="javascript:fFiltrar('tipo_telefone')" style="color: black">Tipo Telefone <img src="imagens/up-arrow.png" width="12px"/></a></b></td>
                    <td><b><a href="javascript:fFiltrar('provincia')" style="color: black">Província <img src="imagens/up-arrow.png" width="12px"/></a></b></td>
                    <td><b><a href="javascript:fFiltrar('cidade')" style="color: black">Cidade <img src="imagens/up-arrow.png" width="12px"/></a></b></td>
