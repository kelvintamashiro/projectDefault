        ...
        <html:form action="Relatorio">
            <table width="90%" class="table-condensed" align="center" id="exportable_table">
                <tr style="background-color: #D3D3D3">
                    <td><b>ID</b></td>
                    <td><b><a href="javascript:fFiltrar('tipo_veiculo')" style="color: black">Tipo Veículo <img src="imagens/up-arrow.png" width="12px"/> </a></b></td>
                    <td><b><a href="javascript:fFiltrar('marca_veiculo')" style="color: black">Marca Veículo <img src="imagens/up-arrow.png" width="12px"/></a></b></td>
                    <td><b><a href="javascript:fFiltrar('nome_veiculo')" style="color: black">Nome Veículo <img src="imagens/up-arrow.png" width="12px"/></a></b></td>
                </tr>
